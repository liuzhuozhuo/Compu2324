...
# Parámetros
# ========================================
file_in = "obligatoria4/datos_vueltas.txt" # Nombre del fichero de datos
file_out = "obligatoria4/videos/test" # Nombre del fichero de salida (sin extensión)
