...
f = open(f"voluntario1/optimizaciones/paralelizado/posiciones_{v_0}.txt", "w")
f_energia = open(f"voluntario1/optimizaciones/paralelizado/energias_{v_0}.txt", "w")
...
file_in = f"voluntario1/optimizaciones/paralelizado/posiciones_{v_0}.txt"
...
f_desplazamiento = open(f"voluntario1/optimizaciones/paralelizado/desplazamiento_{v_0}.txt", "w")
...
f_timer = open(f"voluntario1/optimizaciones/paralelizado/datos_{machine}.txt", "a+")
f_timer.write(f"{N}, {h}, {Time}, {timer}, {num_threads}\n")
f_timer.close()
