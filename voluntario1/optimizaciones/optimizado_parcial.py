...
f = open(f"voluntario1/optimizaciones/optimizado_parcial/posiciones_{v_0}.txt", "w")
f_energia = open(f"voluntario1/optimizaciones/optimizado_parcial/energias_{v_0}.txt", "w")
...
file_in = f"voluntario1/optimizaciones/optimizado_parcial/posiciones_{v_0}.txt"
...
f_desplazamiento = open(f"voluntario1/optimizaciones/optimizado_parcial/desplazamiento_{v_0}.txt", "w")
...
f_timer = open(f"voluntario1/optimizaciones/optimizado_parcial/datos_{machine}.txt", "a+")
