...
f = open(f"voluntario1/optimizaciones/optimizado/posiciones_{v_0}.txt", "w")
f_energia = open(f"voluntario1/optimizaciones/optimizado/energias_{v_0}.txt", "w")
...
file_in = f"voluntario1/optimizaciones/optimizado/posiciones_{v_0}.txt"
...
f_desplazamiento = open(f"voluntario1/optimizaciones/optimizado/desplazamiento_{v_0}.txt", "w")
...
f_timer = open(f"voluntario1/optimizaciones/optimizado/datos_{machine}.txt", "a+")
